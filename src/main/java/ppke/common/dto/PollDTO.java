 ...
 * @param aspects A skála szempontjainak listája (csak Scale esetén releváns, egyébként null - NINCS HASZNÁLVA).
 * @param scaleMin A skála minimum értéke (csak Scale esetén releváns - NINCS HASZNÁLVA).
 * @param scaleMax A skála maximum értéke (csak Scale esetén releváns - NINCS HASZNÁLVA).
