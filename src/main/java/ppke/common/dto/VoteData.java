...
public class VoteData implements Serializable {
    ...
    public static VoteData forWordCloud(List<String> words) {
        ...
        vd.words = new ArrayList<>(words); // Defenzív másolat
        return vd;
    }
    ...
    /**
     * Létrehoz egy VoteData objektumot Scale szavazathoz (NINCS HASZNÁLVA).
    ...
    public static VoteData forScale(Map<String, Integer> aspectRatings) {
        ...
        VoteData vd = new VoteData();
        vd.aspectRatings = new HashMap<>(aspectRatings); // Defenzív másolat
        return vd;
    }
