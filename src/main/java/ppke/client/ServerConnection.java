...
public class ServerConnection {
    ...
    public boolean connect(String address, int port) {
        ...
        try {
            ...
            // FONTOS: Kimeneti stream létrehozása és flush() ELŐSZÖR!
            ...
            // e.printStackTrace(); // Hasznos debuggoláshoz
        }
        ...
        listeningThread = new Thread(() -> {
            ...
            try {
                ...
                while (connected && !Thread.currentThread().isInterrupted()) {
                    Object serverResponse = in.readObject(); // Blokkoló hívás
                    if (uiManager != null) {
                ...
                // Deszerializációs hiba (pl. inkompatibilis osztály verziók)
                if (connected) {
    ...
    public void sendRequest(Request request) {
        ...
        if (connected && out != null) {
            try {
                // System.out.println("ServerConnection: Kérés küldése: " + request.getClass().getSimpleName());
