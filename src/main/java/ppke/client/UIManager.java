...
import ppke.client.controller.*; // Összes kontroller importálása
import ppke.common.dto.*; // Összes DTO importálása
...
public class UIManager {
    ...
    public void showStartScreen() {
        navigateTo(() -> showJoinPollScreen()); // <-- Ennek kell itt lennie!
    }
