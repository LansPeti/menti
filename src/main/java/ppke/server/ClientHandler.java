...
import ppke.common.dto.*; // Import all DTOs
...
import java.util.Locale; // Import Locale for toUpperCase
...
public class ClientHandler implements Runnable {
    ...
    private void processRequest(Request request) {
        ...
        try {
            // Hagyományos if-else if instanceof használatával
    ...
    private Response handleLogin(LoginRequest req) {
        ...
        if (user != null) {
            ...
            // Itt már a ppke.common.dto.PollDTO típust kell visszaadnia a PollManagernek
