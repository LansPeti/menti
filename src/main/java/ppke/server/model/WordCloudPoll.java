...
import java.util.*; // Import Map, List, HashMap, Objects, Locale
...
public class WordCloudPoll extends Poll {
    ...
    public boolean isValidVote(VoteData voteData) {
        ...
        List<String> words = voteData.getWords(); // Ez már másolat
    ...
    protected void calculateResults() {
        ...
        this.wordCounts = newCounts; // Lecseréljük a régit az újra
