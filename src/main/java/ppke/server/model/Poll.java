...
import java.io.*; // IO osztályok importálása
import java.util.*; // List, Map, ArrayList, Collections, Objects, Comparator, Locale importálása
...
public abstract class Poll implements Serializable {
    ...
    // --- ABSZTRAKT METÓDUSOK (Alosztályok implementálják) ---
    ...
    // --- SETTEREK (Szerkesztéshez - csak zárt állapotban engedélyezett!) ---
    ...
    public PollDTO toDTO() {
        ...
        try {
            ...
            // else if (this instanceof ScalePoll sp) { /* ... Scale adatok ... */ }
    ...
    private void readObject(ObjectInputStream ois) throws IOException, ClassNotFoundException {
        ois.defaultReadObject(); // Nem-transient mezők beolvasása
        this.lock = new ReentrantReadWriteLock(true); // Lock újra inicializálása (fair módban)
