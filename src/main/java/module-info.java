/**
 * Modul definíció a Mentimeter Klón alkalmazáshoz (PPKE Java Projekt).
 * Meghatározza a szükséges függőségeket (JavaFX, BCrypt) és
 * megnyitja a szükséges csomagokat a JavaFX FXML betöltő és indító számára.
 */
module ppke.mentimeter.klon { // A modul neve (konzisztens a pom.xml artifactId-vel)
    ...
    // requires javafx.swing; // Csak ha tényleg kell

    // Szükséges BCrypt modul (automatikus modulnévvel)
    requires jbcrypt; // A jbcrypt-0.4.jar alapján
